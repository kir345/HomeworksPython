...
#Пользователь также может ввести имя или фамилию, и Вы должны реализовать функционал для изменения и удаления 
#данных
...
def input_records(file_name: str):
    with open (file_name, "r+", encoding= 'utf - 8') as data:
        ...
        print("Введите Фамилию, Имя, Отечество, номер мобильного телефона ")
